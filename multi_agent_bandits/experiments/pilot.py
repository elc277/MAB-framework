...
def main(steps=1000, save_dir="results/pilot", plot_rewards=False, plot_frequencies=False, seed=None):
        ...
        for n_agents in agent_counts:
            for epsilon in epsilons:
                for run_seed in seeds:
                    ...
                    agents = [
                        EpsilonGreedyAgent(env.n_arms, epsilon=epsilon, name=f"EGreedy(eps={epsilon})")
