...
def main():
    csv_path = os.path.join("results", "pilot_experiment_9-04-2026", "scaling_summary.csv")
    out_dir = os.path.join("results", "pilot_experiment_9-04-2026", "plots")
    ...
    #plot 2: Mean agent reward vs epsilon
    plt.figure(figsize=(8, 5))
    for label in summary["label"].unique():
        sub = summary[summary["label"] == label]
        plt.plot(
    ...
    #plot 5:Normalized reward vs epsilon
