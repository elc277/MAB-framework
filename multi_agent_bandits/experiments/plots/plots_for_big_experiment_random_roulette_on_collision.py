...
if __name__ == "__main__":
    main(
        csv_path=r"results/big_experiment_100_agents_random_roulette_collision/big_experiment_100_agents_random_roulette_collision.csv",
        out_dir=r"results/big_experiment_100_agents_random_roulette_collision/plots"
    )