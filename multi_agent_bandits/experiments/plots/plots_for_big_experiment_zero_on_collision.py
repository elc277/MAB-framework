...
if __name__ == "__main__":
    main(
        csv_path=r"results/big_experiment_100_agents_zero_on_collision/big_experiment_100_agents_zero_on_collision.csv",
        out_dir=r"results/big_experiment_100_agents_zero_on_collision/plots"
    )