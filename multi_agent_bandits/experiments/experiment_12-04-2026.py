#NON REPEATED SCALING EXPERIMENT
import os
import sys
...
def main(steps=1000, save_dir=None, seed=None):
    ...
    if save_dir is None:
        ...
        save_dir = os.path.join(project_root, "results", "experiment_12-04-2026")

    os.makedirs(save_dir, exist_ok=True)
    output_csv = os.path.join(save_dir, "experiment_12-04-2026.csv")
