...
if __name__ == "__main__":
    main(
        csv_path=r"results/full_ratio_sweep_1_to_100_agents_random_roulette_multicore/full_ratio_sweep_1_to_100_agents_random_roulette_collision_multicore.csv",
        out_dir=r"multi_agent_bandits/experiments/plots_new/full_ratio_sweep_1_to_100_agents_random_roulette_multicore_plots"
    )